...
const products = [
  { id: 1, name: "Organic cotton tote bag", price: 50, oldPrice: 70, reviews: 235, rating: 5, image: "/assets/image9.png" },
  { id: 2, name: "Hemp backpack", price: 999, oldPrice: 1199, reviews: 729, rating: 4, image: "/assets/image3.png" },
  { id: 3, name: "Organic cotton T-shirts", price: 499, oldPrice: 699, reviews: 625, rating: 4, image: "/assets/image2.png" },
  { id: 4, name: "Bamboo toothbrush", price: 99, oldPrice: 149, reviews: 244, rating: 5, image: "/assets/image7.png" },
  { id: 5, name: "Bamboo pens and pencils", price: 49, oldPrice: 89, reviews: 1256, rating: 3, image: "/assets/image01.png" },
  { id: 6, name: "Jute grocery bag", price: 59, oldPrice: 89, reviews: 895, rating: 4, image: "/assets/image8.png" },
];
...
export default function BestSellingProducts() {
  return (
    <section className="relative py-12 px-6 md:px-20 bg-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10">
